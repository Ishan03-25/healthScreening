...
import { ArrowLeft, ArrowRight, Activity, Heart } from "lucide-react"
...
export function LifestyleHealth({ data, onUpdate, onNext, onBack }: LifestyleHealthProps) {
      ...
      >
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="space-y-6">
          <motion.div variants={itemVariants} className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-2xl font-bold text-foreground">Lifestyle & General Health</h2>
              <p className="text-muted-foreground">Tell us about your lifestyle and overall health</p>
            </div>
          </motion.div>
